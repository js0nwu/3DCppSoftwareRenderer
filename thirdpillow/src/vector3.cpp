...
void vector3::rotate_degree_xy(float degrees) {
	...
	float x_prime = (this->x*cos(radians)) + (this->y*-sin(radians)) + (this->z*0);
	float y_prime = (this->x*sin(radians)) + (this->y*cos(radians)) + (this->z*0);
...
void vector3::rotate_degree_yz(float degrees) {
	...
	float z_prime = (this->x*-sin(radians)) + (this->y*0) + (this->z*cos(radians));
	this->x = x_prime;
	this->y = y_prime;
	this->z = z_prime;
}
...
void vector3::rotate_degree_xz(float degrees) {
	float radians = (degrees * (float)3.14) / (float)180;
	float x_prime = (this->x*cos(radians)) + (this->y*0) + (this->z*sin(radians));
	float y_prime = (this->x*0) + (this->y*1) + (this->z*0);
	float z_prime = (this->x*-sin(radians)) + (this->y*0) + (this->z*cos(radians));
	this->x = x_prime;
	this->y = y_prime;
